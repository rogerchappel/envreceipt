...
Replace this section with the supported versions for `envreceipt`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `envreceipt` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in envreceipt.
